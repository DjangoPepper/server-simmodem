...
def main_loop():
		...
		if FLAG_OFFLINE == True:
			...
			if FLAG_CAN_RECORD == True and FLAG_RECORDED == False :
				...
				RECORDED_MESSAGE_AS_BYTE = str.encode(RECORDED_MESSAGE)
				print(type(RECORDED_MESSAGE_AS_BYTE))
				
				# RECORDED_MESSAGE_AS_STRING = RECORDED_MESSAGE_AS_BYTE.decode()
				# print(type(RECORDED_MESSAGE_AS_STRING))
